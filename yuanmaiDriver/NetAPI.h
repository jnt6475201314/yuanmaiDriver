...
#if 0   // 上线时使用的
#define CommonHeadUrl @"http://202.91.248.43/project/index.php/Admin"
#endif

#define CHECK_TokenStr_UrlStr [NSString stringWithFormat:@"%@/Appdriver/verify", CommonHeadUrl]  // 检查异地登录
#define API_GETGUIDANCEIMG_URL [NSString stringWithFormat:@"%@/Applineorder/guideImage", CommonHeadUrl]     // 引导页图片

#if 0   // 测试时使用的
#define ForTestCommonHeadUrl @"http://139.196.29.1/"
#endif

#if 1   // 上线时使用的
#define ForTestCommonHeadUrl @"http://202.91.248.43/project/index.php"
#endif


#define API_GETGUIDANCEIMAGE_URL [NSString stringWithFormat:@"%@/Admin/Applineorder/guideImage", ForTestCommonHeadUrl]     // 引导页图片
#define API_guideheadImageUrl [NSString stringWithFormat:@"%@Public/Admin_Uploads/guide_image/", ForTestCommonHeadUrl]


#define API_guideheadImgUrl [NSString stringWithFormat:@"%@/Public/Admin_Uploads/guide_image/", CommonHeadUrl]
