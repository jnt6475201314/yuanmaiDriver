...
#define API_LOGIN_TEL_URL [NSString stringWithFormat:@"%@Appdriver/addWhite", CommonHeadUrl]
...
#define API_OrderUploadReceipt_URL [NSString stringWithFormat:@"%@Appdriver/uploadReceipt", CommonHeadUrl]   // 上传回单
